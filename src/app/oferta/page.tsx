  ...
  return (
    <main className="content-page oferta-page">
      <div className="content-page-container">
        <Breadcrumb items={[{ label: 'Strona główna', href: '/' }, { label: 'Oferta' }]} />
        ...
        <section className="oferta-cta-section" data-scroll-animate>
          ...
          <div className="oferta-cta-images">
            <div className="oferta-cta-image">
              ...
              <div className="oferta-cta-image-overlay">
                <h3>SHOWROOM WARSZAWA</h3>
                <address>Plac Piłsudskiego 9, 00-078 Warszawa</address>
              </div>
            </div>
            <div className="oferta-cta-image">
              <Image
          ...
          <Link href="/kontakt#contact-form" className="content-cta-button">Zarezerwuj termin</Link>
        </section>
